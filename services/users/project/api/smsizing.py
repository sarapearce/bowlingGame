# services/sizing/project/api/sizing.py
...
sizing_blueprint = Blueprint('sizing', __name__, template_folder='./templates')


@sizing_blueprint.route('/sizing/ping', methods=['GET'])
def ping_pong():
    return jsonify({
        'status': 'success',
        'message': 'pong!'
...
@sizing_blueprint.route('/sizing', methods=['GET'])
def get_all_users():
    """Get all users"""
    response_object = {
        'status': 'success',
        'data': {
            'types': [size.to_json() for size in Sizing.query.all()]
        }
    }
    return jsonify(response_object), 200


@sizing_blueprint.route('/sizing/motor', methods=['GET'])
def get_motor_data():
    """Get motor data"""
    response_object = {
        'status': 'success',
...
@sizing_blueprint.route('/sizing/controls', methods=['GET'])
...
@sizing_blueprint.route('/sizing/heads', methods=['GET'])
def get_head_data():
    """Get head data"""
    response_object = {
        'status': 'success',
...
@sizing_blueprint.route('/sizing/panels', methods=['GET'])
def get_panel_data():
    """Get panel data"""
    response_object = {
        'status': 'success',
...
@sizing_blueprint.route('/sizing/plungers', methods=['GET'])
...
@sizing_blueprint.route('/sizing/pressure', methods=['GET'])
...
# @sizing_blueprint.route('/sizing/sizing_data', methods=['GET'])
# def get_sizing_data():
#     """Get Sizing Data"""
#     return get_sizing_data()


@sizing_blueprint.route('/sizing/locations', methods=['GET'])
